...
class _AddButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // context.select targets only the specific condition we care about here
    ...
    return TextButton(
      onPressed: isInCart
          ? null
          : () => context.read<CartModel>().add(item), // context.read for callbacks
      child: isInCart
...
class MyCart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Replaced Consumer/Provider.of with context.watch
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        // context.read is used inside event handlers like onPressed
