...
class MyCart extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Replaced Consumer with Provider.of (listen: true is the default)
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        // listen: false is used here because it is inside a button callback
...
class _CartTotal extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Replaced Consumer with Provider.of
    final cart = Provider.of<CartModel>(context);
